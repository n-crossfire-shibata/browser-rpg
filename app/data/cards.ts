...
export const BASIC_CARDS: Card[] = [
  ...
  },
  {
    ...
    flavor: '盾で敵を叩きつけ、バランスを崩した隙に攻撃する。',
    cost: 2,
    type: 'attack',
    rarity: 'common',
    effects: [
